...
<table>
	...
	<?php 
		$select = $db->query ("SELECT * FROM `agenda_rdv`,`agenda_patient`, `agenda_praticien` 
				...
				GROUP BY agenda_patient.id_patient 
				ORDER BY nom ASC ");
	...
	?>
 			 	...
 			 	<tr align="center"> 
      				 ...
      				 <td width=300> <a href="fiche_patient.php?action=afficher&amp;id=<?php echo $s->id_patient;?>"> <?php echo $s->nom;?> <?php echo $s->prenom;?></a></td>
      				 <td width=300><?php echo $s->date_naissance;?> </td>
      				 <td width=300> <a href="fiche_medecin.php?action=afficher&amp;id=<?php echo $s->id_praticien;?>"> <?php echo $s->nom_medecin;?></a></td>
